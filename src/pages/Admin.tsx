    ...
    <main className="min-h-screen bg-monare-gradient pb-12">
      ...
      <div className="max-w-5xl mx-auto px-5">
        <Tabs defaultValue="mostruario" className="w-full">
          <TabsList className="grid w-full grid-cols-6 bg-white/70 border border-bege">
            ...
            <TabsTrigger value="clientes" className="data-[state=active]:bg-rosa data-[state=active]:text-white">
            ...
            <TabsTrigger value="nova-usuaria" className="data-[state=active]:bg-rosa data-[state=active]:text-white">
